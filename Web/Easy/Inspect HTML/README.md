...
> Đề bài :Can you get the flag? Go to this website and see what you can discover.
> http://saturn.picoctf.net:56006/

Trang web hiện ra 1 giao diện text html đơn giản.
...
Có thể thấy ngay `flag` trong phần comment.

> Đây là 1 bài easy web nên có thể tìm thấy flag ngay trong source code.
